...
parser.add_argument(
    "--class-weight", type=float, default=0.1, help="weight of classification loss in anchor to gt matching"
)
add_bool_arg(parser, "use-pred-boxes", default=False, help="use predicted boxes instead of anchor boxes in matching")
...
def main():
    ...
    with set_layer_config(scriptable=args.torchscript):
        model = create_model(
            ...
            image_size=(512, 768),
            use_pred_boxes=args.use_pred_boxes,
