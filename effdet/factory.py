...
def create_model(
    ...
    **kwargs
    ...
    return create_model_from_config(
        ...
        predict_uncertainties=predict_uncertainties,
        **kwargs
    )
...
def create_model_from_config(
    ...
    **kwargs
    ...
    use_pred_boxes = kwargs.pop("use_pred_boxes", False)
    class_weight = kwargs.pop("class_weight", 0.0)
